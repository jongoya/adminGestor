            ...
            return B(A, [{
                ...
                value: function() {
                    ...
                    e.input.addEventListener("change", function() {
                        //TODO click cuando selecciono la imagen del buscador
                        if (e.uploadId == "fondoLoginImage") {
                            fondoLoginImageSelected = true;
                        } else if(e.uploadId == "iconoAppPublico") {
                            iconoAppPublicoSelected = true;
                        } else {//iconoAppPrivado
                            iconoAppPrivadoSelected = true;
                        }
                        e.addFiles(this.files)
                    }, !0), this.clearButton.addEventListener("click", function() {
                        //TODO Cuando clicko el cross button
                        A.clearPreviewPanel()
                    }, !0), this.imagePreview.addEventListener("click", function(e) {
                        //TODO Cuando clicko sobre la imagen
